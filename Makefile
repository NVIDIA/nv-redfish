...
define build-and-test
	...
	cargo build -p nv-redfish --features oem-nvidia-baseboard
	cargo build -p nv-redfish --features oem-nvidia-bluefield
	cargo build -p nv-redfish --features computer-systems,oem-nvidia-bluefield
	cargo build -p nv-redfish --features chassis,oem-nvidia-baseboard
